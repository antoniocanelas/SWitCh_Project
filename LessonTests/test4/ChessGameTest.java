...
import exercise4.ChessGame;

public class ChessGameTest {
	char[][] initialTable = { 		{ 't', 'c', 'b', 'q', 'r', 'b', 'c', 't' },
									{ 'p', 'p', 'p', 'p', 'p', 'p', 'p', 'p' }, 
									{ 'P', 'L', 'L', 'L', 'T', 'L', 'L', 'L' },
									{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' }, 
									{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
...
char[][] rookTable = 	      { { 'L', 'L', 'L', 'L', 'P', 'L', 'L', 'L' },
								{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' }, 
								{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
								{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
								{ 'L', 'c', 'L', 'L', 'T', 'L', 'c', 'L' },
...
char[][] bishopTable = 		  { { 'B', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
								{ 'L', 'T', 'L', 'L', 'L', 'L', 'L', 'L' }, 
								{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
								{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
								{ 'L', 'L', 'L', 'L', 'b', 'L', 'L', 'L' },
...
char[][] queenTable = {  { 'L', 'L', 'L', 'L', 'P', 'L', 'L', 'L' },
						{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' }, 
						{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' },
						{ 'L', 'L', 'L', 'L', 'L', 'L', 'L', 'L' }, 
						{ 'L', 'c', 'L', 'L', 'Q', 'L', 'c', 'L' },
