...
public class SquarePaint {
	...
	static char[] steps = { 'P', 'F', 'P', 'F', 'R', 'R', 'R', 'F', 'F', 'P', 'R', 'R', 'F', 'P', 'R', 'F', 'P', 'R',
			'R', 'F', 'F', 'F' };
	static char[][] matrix = new char[6][6];
	static String direction = "RIGHT";
	static char step = 'F';
	static int[] positionCoordinates = { 0, 0 };
	static final int TABLE_LIMIT = 5;
	static int charFind;
	static char[] newStepsArray;
	static int numberOfRemovedSteps = 0;
