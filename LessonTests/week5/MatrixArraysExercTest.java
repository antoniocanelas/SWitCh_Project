...
public class MatrixArraysExercTest {
    ...
    @Test
    public void somaArrayEquals() throws Exception {

	int[] in1 = { 1, 2, 3 };
	int[] in2 = { 3, 2, 1 };
	int[] out = { 4, 4, 4 };

	ArraysExerc array1 = new ArraysExerc(in1);
	ArraysExerc array2 = new ArraysExerc(in2);
	ArraysExerc expected = new ArraysExerc(out);
	array1.somaArray(array2);

	assertEquals(expected, array1.somaArray(array2));

    }

    @Test
    public void somaArrayNotEquals() throws Exception {
	...
	assertNotEquals(expected, array1.somaArray(array2));

    }

    @Test(expected = Exception.class)
    public void somaArrayException() throws Exception {
    ...
    @Test
    public void bubbleSortEquals() throws Exception {
	...
	assertEquals(expected, array1.bubbleSort());

    }

    @Test
    public void bubbleSortNotEquals() throws Exception {
	...
	assertNotEquals(expected, array1.bubbleSort());
